    ...
    <header class="p-4 bg-[#151A1E] text-white">
      <div class="container flex justify-between items-center mx-auto">
        ...
        <nav v-if="!isLoginRoute" class="hidden md:flex space-x-6">
          <router-link to="/" class="hover:text-red-500 font-semibold">Inicio</router-link>
          <router-link to="/servicios" class="hover:text-red-500 font-semibold">Servicios</router-link>
          <router-link to="/reservas" class="hover:text-red-500 font-semibold">Reservas</router-link>
          <router-link to="/contacto" class="hover:text-red-500 font-semibold">Contacto</router-link>
          <!-- Condición para mostrar el enlace de Admin solo si el usuario es administrador -->
          <router-link v-if="isUserAdmin" to="/admin" class="hover:text-red-500 font-semibold">Admin</router-link>
      ...
      <nav v-if="isMobileMenuOpen && !isLoginRoute" class="md:hidden w-full right-0 top-16 bg-gray-800 p-4">
        <router-link to="/" class="block hover:text-red-500 font-semibold" @click="toggleMobileMenuClose">Inicio</router-link>
        <router-link to="/servicios" class="block hover:text-red-500 font-semibold" @click="toggleMobileMenuClose">Servicios</router-link>
        <router-link to="/reservas" class="block hover:text-red-500 font-semibold" @click="toggleMobileMenuClose">Reservas</router-link>
        <router-link to="/contacto" class="block hover:text-red-500 font-semibold" @click="toggleMobileMenuClose">Contacto</router-link>
        <!-- Condición para mostrar el enlace de Admin solo si el usuario es administrador -->
        <router-link v-if="isUserAdmin" to="/admin" class="block hover:text-red-500 font-semibold" @click="toggleMobileMenuClose">Admin</router-link>
